...
tmp = ['/home/zz/Downloads/CARLA_0.9.6/PythonAPI/carla-0.9.6-py2.7-linux-x86_64.egg',
       '/home/zz/carmaker_ros/ros/ros1_ws/devel/lib/python2.7/dist-packages',
...
print("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ",sys.path,"ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ")
...
def game_loop(args):
    ...
    try:
        ...
        display = pygame.display.set_mode(
            ...
            pygame.HWSURFACE | pygame.DOUBLEBUF) #pygame window 출력

        hud = HUD(args.width, args.height)  #왼쪽 메뉴(HUD) 생성
